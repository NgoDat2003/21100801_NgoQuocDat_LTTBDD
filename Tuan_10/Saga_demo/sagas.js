...
function* createDataSaga(action) {
    try {
        const response = yield call(axios.post, 'https://66fc9741c3a184a84d176b30.mockapi.io/bai1', action.payload);
...
function* updateDataSaga(action) {
    try {
        const response = yield call(axios.put, `https://66fc9741c3a184a84d176b30.mockapi.io/bai1/${action.payload.id}`, action.payload.data);
...
function* deleteDataSaga(action) {
    try {
        yield call(axios.delete, `https://66fc9741c3a184a84d176b30.mockapi.io/bai1/${action.payload}`);
